...
gulp.task('build', 'To generate a custom builds inside the prod folder.', function(cb){
...
//Clean Task
gulp.task('clean', 'To clean the custom builds inside the prod folder.', function() {
